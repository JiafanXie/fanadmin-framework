...
class Alipay extends BasePay
{
    ...
    protected function initialize(array $config = [])
    {
        ...
        $config['app_public_cert_path'] = urlToPath($config['app_public_cert_path'] ?? '');
        $config['alipay_public_cert_path'] = urlToPath($config['alipay_public_cert_path'] ?? '');
        $config['alipay_root_cert_path'] = urlToPath($config['alipay_root_cert_path'] ?? '');
