 ...
 * 枚举基类
 * Class BaseEnum
 * @package core\base\enum
 */
abstract class BaseEnum extends BaseDriver
{
    /**
     * @var string 插件整体缓存标识
     */
     ...
     * @return string
     */
    protected function getCoreAppPath()
    {
        return root_path() . "core/src" . DIRECTORY_SEPARATOR;
    }
     ...
     * @return string
     */
    protected function getCoreAddonAppPath(string $addon)
    {
        return root_path() . "core/src/addon" . DIRECTORY_SEPARATOR . $addon . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR;
    }
