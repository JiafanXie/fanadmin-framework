...
use core\src\http\service\admin\addon\cloud\ModuleCloudService;
 ...
 */
class AddonDownloadService extends BaseAddonService
{
...
//        if(is_dir($app_path)) throw new NiucloudException();
        //下载文件到本地
        $zip_file = (new AddonCloudService())->downloadAddon($app_key, $version);
        //解压到应用addon下
        //删除旧版本文件
