...
use core\src\http\service\admin\addon\AddonDevelopDownloadService;
...
/**
 * 云编译服务
 * Class BuildCloudService
 * @package core\lib\addon\cloud
 */
class BuildCloudService extends BaseService
{
    ...
    public function __construct()
    {
        ...
        $this->auth_code = (new ConfigCloudService())->getNiucloudConfig()['auth_code'] ?? '';
    }
